...
public class RemoteProductClient {
    ...
    public RemoteProductClient(String url, CircuitBreaker productBreaker, CircuitBreaker similarIdsBreaker) {
        this.productBreaker = productBreaker;
        this.similarIdsBreaker = similarIdsBreaker;
